...
router.post(
  "/profile-views",
  authenticateToken,
  userController.recordProfileView
);
router.get(
  "/profile-views/viewers",
  authenticateToken,
  userController.getProfileViewers
);
router.get(
  "/profile-views/analytics",
  authenticateToken,
  userController.getProfileViewAnalytics
);
router.get(
  "/profile-views/activity",
  authenticateToken,
  userController.getProfileViewActivity
);
router.put(
  "/settings/profile-view-privacy",
  authenticateToken,
  userController.updateProfileViewPrivacy
);
...
router.post(
  ...
  authenticateToken,
  userController.connectCalendar
);
router.delete(
  "/integrations/calendar/disconnect",
  authenticateToken,
  userController.disconnectCalendar
);
router.get(
...
router.post(
  ...
  authenticateToken,
  userController.syncCalendarEvents
);
...
router.get(
  ...
  authenticateToken,
  userController.getSocialAccounts
);
router.post(
  "/integrations/social/share",
  authenticateToken,
  userController.shareToSocial
);
router.get(
  "/integrations/social/shares",
  authenticateToken,
  userController.getShareHistory
);
...
router.get(
  "/notification-tokens",
  authenticateToken,
  userController.getNotificationTokens
);
